<template>
  <div class="maze full-width" tabindex="-1" @keyup="onKeyUp">
...
export default {
  ...
  methods: {
    onTouchStart(event) {
      ...
      this.cache = {};
      this.cache.rect = this.cache.avatorPosition = this.cache.originalPosition = set(
        this,
        'cache',
        {
